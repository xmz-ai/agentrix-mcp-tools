...
const GEMINI_BASE_URL = process.env.AGENTRIX_GEMINI_BASE_URL || process.env.GEMINI_BASE_URL || "https://generativelanguage.googleapis.com/v1beta";
const GEMINI_API_KEY = process.env.AGENTRIX_GEMINI_API_KEY || process.env.GEMINI_API_KEY;
const GEMINI_MODEL = process.env.AGENTRIX_GEMINI_IMAGE_MODEL || "gemini-2.5-flash-image";
